...
class TextureRectangle(Physical):
    def __init__(self,shape, display, image_name: str,image_loader: ImageLoader, camera: Camera, pos: Tuple[float, float], size: Tuple[float, float]):
        self.display = display
        self.size = size
        self.image_loader = image_loader
        self.image_name = image_name
        self.pos = pos
        super().__init__(shape, display, camera)
